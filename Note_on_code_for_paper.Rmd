...
Figure 5 in the paper is generated in `create_combined_dominance_finemapping_tables_from_results.r`. I've added lines (starting at 119) to filter down to curated phenotypes before plotting. It's saved at `heritability_paper_figures_and_tables/paper_figure_5.pdf`.
...
# Run get_variances_for_dominance_hit_phenotypes_hail.py, do create gs://ukbb-dominance/variance_of_phenotypes_with_dominance_hit_0.01_pHWE_1e-10.csv
...
# Before running run_submit_biomarker_finemap_inputs_hail_input.r I need to move the GWAS files to the broad cluster!
