...
bash /home/unix/dpalmer/Repositories/ldscgxe_paper/biomarker_finemapping_rerun/finemapping_hail_input.sh ${pheno} ${full_phenotype_file} ${incl_file} ${dom_file} ${add_file} ${out} ${maf_locus} ${maf_finemap} ${p_hwe_finemap}
