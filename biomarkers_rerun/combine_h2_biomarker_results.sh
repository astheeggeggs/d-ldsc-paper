...
path_to_h2_folder="/psych/genetics_data/dpalmer/UKbb/ldsc-dominance-biomarkers-export-rerun/h2-results"
outdir=${path_to_h2_folder}/combined
mkdir $outdir

file_to_write="${outdir}/biomarkers_rerun.h2";
echo $file_to_write;
...
scp dpalmer@login01:/psych/genetics_data/dpalmer/UKbb/ldsc-dominance-biomarkers-export-rerun/h2-results/combined/* h2_estimates/
