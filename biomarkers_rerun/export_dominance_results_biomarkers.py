...
# hailctl dataproc submit dp export_dominance_results_biomarkers.py pipeline
...
ht_results = hl.read_table(f'gs://ukbb-dominance/biomarkers/results/ukb31063.biomarker_gwas_results.{sex}.{contig}.pipeline_{pipeline}_rerun.ht')
...
for i, phenotype in enumerate(phenotypes):
    ...
    ht_export.export(f'gs://ukb-mega-gwas-results/round2/dominance-biomarkers-tsvs/{code}_{variable_type}.gwas.imputed_v3.{sex}.rerun.tsv.bgz')
