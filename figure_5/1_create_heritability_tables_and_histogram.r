...
# DEV: add key to the plots.
# DEV: send the resulting plots to the biobank slack.
...
# Amazing, there are only two where the phenotype numbers differ here. What are they?
# and these are 'age' and 'is_female'. Great!
