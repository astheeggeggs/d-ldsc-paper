...
ht_results = hl.read_table(f'gs://ukbb-dominance/biomarkers/results/no_HWE_assumption/ukb31063.biomarker_gwas_results.{sex}.{contig}.pipeline_{pipeline}_no_HWE_assumption_GP_without_var_rescale.ht')
...
for i, phenotype in enumerate(phenotypes):
    ...
    # ht_export.export(f'gs://ukb-mega-gwas-results/round2/dominance-biomarkers-tsvs-no-HWE-assumption/{code}_{variable_type}.gwas.imputed_v3.{sex}.no_HWE_assumption_GP.tsv.bgz')
    ht_export.export(f'gs://ukb-mega-gwas-results/round2/dominance-biomarkers-tsvs-no-HWE-assumption/{code}_{variable_type}.gwas.imputed_v3.{sex}._no_HWE_assumption_GP_without_var_rescale.tsv.bgz')
